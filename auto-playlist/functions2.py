...
def get_playlist_tracks(playlist_ids, spotify_object, market=None):
    ...
    for playlist_id in playlist_ids:
        ...
        if playlist_id == 'library':
            ...
            result = spotify_object.playlist_tracks(
                playlist_id=playlist_id, market=market)
...
def get_albums_features(album_ids, spotify_object):
    ...
    for i in range(0, loops):  # 0 - 1
        album_features = spotify_object.albums(
            album_ids[i * 20:(i * 20) + 20])  # first 20
...
def get_artists_features(artist_ids, spotify_object):
    ...
    j = 0
    for i in range(0, loops):  # 0 - 1
        artist_features = spotify_object.artists(
            artist_ids[i * 50:(i * 50) + 50])  # first 20
...
def get_tracks_features(track_ids, spotify_object):
    ...
    j = 0
    for i in range(0, loops):  # 0 - 1
        track_features = spotify_object.audio_features(
            track_ids[i * 50:(i * 50) + 50])  # first 20
